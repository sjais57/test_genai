...
class GESService:
    ...
    def initialize(self):
        ...
        try:
            ...
            self.service = EntitlementsService(
                hostname=hostname,
                port=port,
                namespace="default",  # Temporary, will be overridden
                client_id=client_id,
    ...
    def get_user_groups_in_namespace(self, username: str, namespace: str) -> List[str]:
        ...
        Args:
            ...
            namespace: The namespace to check (from API key YAML)
        ...
        try:
            ...
            namespace_service = EntitlementsService(
                ...
                namespace=namespace,  # Use the namespace from API key YAML
    ...
    def get_user_groups_in_namespaces(self, username: str, namespaces: List[str]) -> Dict[str, List[str]]:
        """
        Get user's groups across multiple namespaces (from API key YAML)
        
        Args:
            username: The username
            namespaces: List of namespaces from API key YAML to check
